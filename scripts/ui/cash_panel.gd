...
func setup(p_hud: Hud) -> void:
	...
	UIKit.header(self, "money", "Efectivo y riesgo", func(): closed.emit(), [UIKit.icon_button("refresh", refresh, "Actualizar", "", 16)])
...
func _title(text: String) -> void:
	...
	h.add_child(UIKit.icon("finance", 16, UIKit.ACCENT))
